        ...
        <Grid gridTemplateColumns={"repeat(12, 1fr)"} gap={4}>
          ...
          <GridItem colSpan={[12, 12, 5]}>
            <AuthInput
              ...
              fontSize={"sm"}
              name="address"
              value={currentFacility?.medicalProffessional.address}
          ...
          <GridItem colSpan={[12, 12, 4]}>
            <AuthInput
              ...
              label={"Nationality"}
              name="nationality"
              value={currentFacility?.medicalProffessional.nationality}
              isSelect
        ...
        <Grid gridTemplateColumns={"repeat(12, 1fr)"} gap={4}>
          <GridItem colSpan={[12, 12, 5]}>
            <AuthInput
              ...
              iconProp={{ fontSize: "xl" }}
              name="qualification"
              value={currentFacility?.medicalProffessional.qualification}
          ...
          <GridItem colSpan={[12, 12, 7]}>
            <AuthInput
              ...
              fontSize={"sm"}
              name="institution"
              value={currentFacility?.medicalProffessional.institution}
          ...
          <GridItem colSpan={[12, 12, 4]}>
            <AuthInput
              ...
              value={currentFacility?.medicalProffessional.registration_number}
          ...
          <GridItem colSpan={[12, 12, 2]}>
            <AuthInput
              ...
              value={currentFacility?.medicalProffessional.year_of_qualification}
          ...
          <GridItem colSpan={[12, 12, 2]}>
            <AuthInput
              ...
              value={currentFacility?.medicalProffessional.year_of_registration}
          ...
          <GridItem colSpan={[12, 12, 4]}>
            <AuthInput
              ...
              value={currentFacility?.medicalProffessional.approving_authority}
