...
import { FACILITY_CATEGORY_ENDPOINT, FACILITY_SECTOR_ENDPOINT, GET_PROTECTIVE_ITEM, NON_COMP_LIST_ENDPOINT, REQUIRED_DOCS_ENDPOINT, SERVICE_SCOPE_ENDPOINT, WASTE_DISPOSAL_ENDPOINTS } from "."
...
export const executeGetFacilitySectors = async (token: string): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
      headers: {
        "Content-Type": "application/json",
...
export const executeGetFacilityCategory = async (token: string): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
      headers: {
        "Content-Type": "application/json",
...
export const executeGetDisposalMethods = async (token: string): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
      headers: {
        "Content-Type": "application/json",
...
export const executeGetServiceScope = async (token: string): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
      headers: {
        "Content-Type": "application/json",
...
export const executeGetProtectiveItems = async (token: string): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
      headers: {
        "Content-Type": "application/json",
...
export const executeGetNonCompliments = async (token: string): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
      headers: {
        "Content-Type": "application/json",
