...
export const UPDATE_FACILITY_STATUS_ENDPOINT =
  BASE_URL + "/update-facility-status";
export const GET_ALL_FACILITIES_ENDPOINT = BASE_URL + "/all-facilities";
export const GET_FACILITY_ADDONS_ENDPOINT = BASE_URL + "/feature-addon-items";
export const SEARCH_ALL_FACILITIES_ENDPOINT = (query: string) =>
  BASE_URL + `/search-all-facilities?query=${query}`;
export const UPGRADE_FACILITY_ENDPOINT = BASE_URL + "/send-upgrade-request";
export const GET_ALL_FACILITY_CATEGORIES =
...
export const UPDATE_FACILITY_SERVICE_ENDPOINT =
  BASE_URL + "/update-facility-service";
export const ADD_PROFESSIONAL_INCHARGE_ENDPOINT =
  BASE_URL + "/add-professional-incharge";
export const ADD_PROF_STAFF_ENDPOINT = BASE_URL + "/add-prof-staff-complement";
export const ADD_NON_PROF_STAFF_ENDPOINT =
  BASE_URL + "/facility-non-prof-staff-compl";
...
export const ADD_NON_PROF_MEMBER_ENDPOINT =
  BASE_URL + "/non-professional-staff";

export const DELETE_PROFFESSIONAL_STAFF_ENDPOINT = (id: number) =>
  BASE_URL + "/professional-staff/" + id;
export const DELETE_NON_PROFFESSIONAL_STAFF_ENDPOINT = (id: number) =>
  BASE_URL + "/non-professional-staff/" + id;

export const GET_PROFFESSIONAL_STAFF_ENDPOINT = (
  facilityID: number,
  page: number = 1,
  perPage: number = 15
) => BASE_URL + `/professional-staff/${facilityID}/${page}/${perPage}`;
export const GET_NON_PROFFESSIONAL_STAFF_ENDPOINT = (
  facilityID: number,
  page: number = 1,
  perPage: number = 15
) => BASE_URL + `/non-professional-staff/${facilityID}/${page}/${perPage}`;
export const GET_ONE_FACILITY_ENDPOINT = (id: number) =>
  BASE_URL + "/facility-detail/" + id;
export const GET_FACILITY_DOCS_ENDPOINT = (name: string) =>
  BASE_URL + "/facility-document/" + name;
...
export const TOGGLE_CARD_VISIBILITY_ENDPOINT =
  BASE_URL + "/toggle-card-visibility";
...
export const GET_USERS_ENDPOINT = (page: number, perPage: number) =>
  BASE_URL + `/all-users/${page}/${perPage}`;
export const GET_USER_FACILITIES_ENDPOINT = (
  id: number,
  page: number,
  perPage: number
) => BASE_URL + `/user-facilities/${id}/${page}/${perPage}`;
export const CREATE_USER_ENDPOINT = BASE_URL + "/create-user";
export const UPDATE_USER_ENDPOINT = BASE_URL + "/update-user-profile";
...
export const GET_USER_PROFILE_ENDPOINT = (id: number) =>
  BASE_URL + `/user-profile/${id}`;
export const DELETE_USER_ACCOUNT = (id: number) => BASE_URL + `/user/${id}`;
export const GET_ROLES_ENDPOINT = (page: number, perPage: number) =>
  BASE_URL + `/all-roles/${page}/${perPage}`;
export const GET_ONE_ROLE_ENDPOINT = (id: number) =>
  BASE_URL + "/role-detail/" + id;
export const TOGGLE_ROLE_ENDPOINT = (id: number, status: boolean) =>
  BASE_URL + `/toggle-status/${id}/${status}`;
export const GET_PERMISSIONS_ENDPOINT = BASE_URL + "/all-permissions";
export const GET_USER_POSSIBLE_PERMISSIONS_ENDPOINT = (id: number) =>
  BASE_URL + `/possible-user-permissions/${id}`;
export const CREATE_PERMISSION_ENDPOINT = BASE_URL + "/create-permission";
export const UPDATE_USER_PERMISSION_ENDPOINT =
  BASE_URL + "/update-user-permission";
...
export const GET_ALL_USER_ACTIVITIES = (
  page: number = 1,
  perPage: number = 15
) => BASE_URL + `/history/${page}/${perPage}`;
export const GET_ALL_LOGS = (page: number = 1, perPage: number = 15) =>
  BASE_URL + `/logs/${page}/${perPage}`;
export const GET_ALL_SCHEDULED_INSPECTIONS = (
  page: number = 1,
  perPage: number = 15,
  status: string
) =>
  BASE_URL +
  `/inspection-schedules?page=${page}&perPage=${perPage}&status=${status}`;
export const GET_ONE_PERMISSION_ENDPOINT = (id: number) =>
  BASE_URL + "/permission-detail/" + id;
...
export const READ_NOTIFICATIONS_ENDPOINT = (id: number) =>
  BASE_URL + "/read-notification/" + id;
export const GET_ALL_INVOICES = BASE_URL + `/invoices`;
export const GET_ALL_PENALTIES = BASE_URL + `/penalties`;
export const GET_ALL_INVOICE_HISTORY = (
  id: number,
  page: number,
  perPage: number
) => BASE_URL + `/invoice-history/${id}/${page}/${perPage}`;
...
export const GET_PENALTY_ITEMS = (id: number) =>
  BASE_URL + `/penalty-items/${id}`;
export const GET_ALL_FEES = (f_id: string) =>
  BASE_URL + `/fees?f_category=${f_id ?? ""}`;
export const UPDATE_FEE_ENDPOINT = BASE_URL + "/fee";
export const CREATE_FEE_ENDPOINT = BASE_URL + "/create-fee";
export const GET_INVOICE_STAFF_ENDPOINT = (
  facilityID: number,
  page: number = 1,
  perPage: number = 15
) => BASE_URL + `/invoices/${facilityID}/${page}/${perPage}`;
export const PAY_INVOICE_ENDPOINT = BASE_URL + "/pay-invoice";
export const DOWNLOAD_INVOICE_ENDPOINT = (invoiceId: number) =>
  BASE_URL + "/download-invoice/" + invoiceId;
export const GET_CONDUCTED_ENDPOINT = (
  facilityID: number,
  page: number = 1,
  perPage: number = 15
) => BASE_URL + `/inspection-records/${facilityID}/${page}/${perPage}`;
export const GET_SCHEDULE_ENDPOINT = (
  facilityID: number,
  page: number = 1,
  perPage: number = 15
) => BASE_URL + `/inspection-schedules/${facilityID}/${page}/${perPage}`;
export const DASHBOARD_CARD_ENDPOINT = BASE_URL + `/dashboard-cards`;
export const DASHBOARD_FACILITY_CARD_ENDPOINT = (id: number) =>
  BASE_URL + `/dashboard-cards/` + id;
