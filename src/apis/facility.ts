...
import {
  ...
  ADD_PROFESSIONAL_INCHARGE_ENDPOINT,
  ADD_PROF_STAFF_ENDPOINT,
  DELETE_FACILITY_ENDPOINT,
  GET_ALL_FACILITIES_ENDPOINT,
  GET_PROFFESSIONAL_STAFF_ENDPOINT,
  LETTER_OF_INTENT_ENDPOINT,
  UPDATE_FACILITY_SERVICE_ENDPOINT,
  DELETE_PROFFESSIONAL_STAFF_ENDPOINT,
  ADD_PROF_MEMBER_ENDPOINT,
  DELETE_NON_PROFFESSIONAL_STAFF_ENDPOINT,
  GET_NON_PROFFESSIONAL_STAFF_ENDPOINT,
  ADD_NON_PROF_MEMBER_ENDPOINT,
  GET_NOTIFICATIONS_ENDPOINT,
  GET_INVOICE_STAFF_ENDPOINT,
  GET_ONE_FACILITY_ENDPOINT,
...
export const executeDocumentFacility = async (
  data: any,
  token: string
): Promise<ResponseDataType> => {
  try {
...
export const executeGetOneFacility = async (
  id: number,
  token: string
): Promise<ResponseDataType> => {
  try {
...
export const executeGetFacilities = async (
  token: string
): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
...
export const executeSaveFacilityService = async (
  data: ServiceData,
  token: string
): Promise<ResponseDataType> => {
  try {
...
export const executeAddProIncharge = async (
...
export const executeUploadFacilityDocs = async (
  data: FormData,
  token: string
): Promise<ResponseDataType> => {
  try {
...
export const executeAddProfessionalMember = async (
  data: ProffessionalStaffData & { facility_id: number },
  token: string
): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
...
export const executeAddNonProfessionalMember = async (
  data: NonProfessionalStaffData & { facility_id: number },
  token: string
): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
...
export const executeAddNonProfessional = async (
  data: NonProfessionStaff,
  token: string
): Promise<ResponseDataType> => {
  try {
    const options: RequestInit = {
...
export const executeDeleteFacility = async (
  ids: number[],
  token: string
): Promise<ResponseDataType> => {
  try {
...
export const executeGetFacilityProffessionalMembers = async (
  facilityId: number,
  token: string,
  page: number = 1,
  perPage: number = 15
  ...
  try {
    ...
    const request = await fetch(
      GET_PROFFESSIONAL_STAFF_ENDPOINT(facilityId, page, perPage),
      options
    );
    const response = (await request.json()) satisfies ResponseDataType;
    return response;
...
export const executeGetNonFacilityProffessionalMembers = async (
  facilityId: number,
  token: string,
  page: number = 1,
  perPage: number = 15
  ...
  try {
    ...
    const request = await fetch(
      GET_NON_PROFFESSIONAL_STAFF_ENDPOINT(facilityId, page, perPage),
      options
    );
    const response = (await request.json()) satisfies ResponseDataType;
    return response;
...
export const executeDeleteProffessionalStaff = async (
  id: number,
  token: string
): Promise<ResponseDataType> => {
  try {
    ...
    const request = await fetch(
      DELETE_PROFFESSIONAL_STAFF_ENDPOINT(id),
      options
    );
    const response = (await request.json()) satisfies ResponseDataType;
    return response;
...
export const executeDeleteNonProffessionalStaff = async (
  id: number,
  token: string
): Promise<ResponseDataType> => {
  try {
    ...
    const request = await fetch(
      DELETE_NON_PROFFESSIONAL_STAFF_ENDPOINT(id),
      options
    );
    const response = (await request.json()) satisfies ResponseDataType;
    return response;
...
export const executeGetFacilityNotification = async (
  facility_id: number,
  token: string,
  page: number = 1,
  perPage: number = 9
...
export const executeGetFacilityInvoices = async (
  facilityId: number,
  token: string,
  page: number = 1,
  perPage: number = 9
...
export const executeGetFacilityDashboardCards = async (
  facilityId: number,
  token: string
): Promise<ResponseDataType> => {
  try {
    ...
    const request = await fetch(
      DASHBOARD_FACILITY_CARD_ENDPOINT(facilityId),
      options
    );
    const response = (await request.json()) satisfies ResponseDataType;
    return response;
