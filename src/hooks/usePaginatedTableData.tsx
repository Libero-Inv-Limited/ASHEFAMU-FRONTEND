...
const usePaginatedTableData = (dataFunc: (page?: number, perPage?: number) => Promise<ResponseDataType>, _perPage: number = 15 ): IusePaginatedTableData => {
  ...
  return { handlePageChange, handlePerRowsChange, handleReloadData, data, loadingData, totalRows, currentPage, perPage, lastPage }
}
