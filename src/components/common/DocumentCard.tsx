...
import documentImage from "../../assets/ms.png";
...
const DocumentCard: React.FC<DocumentCardProps> = ({ name }) => {
  ...
  const extensionToImage = {
    ...
    docx: documentImage, // Change to the actual image file for DOCX
    default: documentImage, // Change to a default image for other file types
  };

  const imageSource =
    extensionToImage[fileExtension] || extensionToImage.default;
