import { Center, Circle, CloseButton, Icon, IconButton, Stack, Text, VStack } from "@chakra-ui/react"
...
const Sidebar: React.FC<SidebarProps> = ({ onClose, toggleSecondaryBar, isSecondaryBarOpen }) => {
